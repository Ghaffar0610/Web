...
@app.route("/")
def index():
    # This serves the file located at templates/index.html
    return render_template("index.html")

# 3. Define the route for the About Page
@app.route("/about")
def about():
    # This serves the file located at templates/about.html
    return render_template("about.html")

# 4. Local Testing Configuration
# This part allows you to run the website on your own computer for testing
if __name__ == "__main__":
    app.run(debug=True)

# 5. Vercel Configuration
# This line is critical. Vercel looks for this variable to start the server.
app = app
